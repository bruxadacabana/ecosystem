...
GET    /domains            : página de gerenciamento
...
from database import add_blocked_domain, list_blocked_domains, remove_blocked_domain
...
async def domains_page(request: Request) -> HTMLResponse:
    domains = await list_blocked_domains()
